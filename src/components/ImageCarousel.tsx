		...
		<View style={styles.imageCarouselContainer}>
			<View
				style={styles.selectedThumbnail}>
				{
					...
					<TouchableOpacity onPress={() => handleNext()} style={styles.iconNext}>
						<MaterialIcons name="navigate-next" size={24} color={theme.colorLogo} />
					</TouchableOpacity>
				}

				{
					selectedImageIndex!==0&&
					<TouchableOpacity onPress={() => handlePrevious()} style={styles.iconBack}>
